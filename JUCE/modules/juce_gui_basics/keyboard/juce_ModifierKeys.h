...
public:
    ...
    */
    ...
    inline bool isX1ButtonDown() const noexcept         { return testFlags (backButtonModifier); }

    inline bool isX2ButtonDown() const noexcept         { return testFlags (forwardButtonModifier); }
