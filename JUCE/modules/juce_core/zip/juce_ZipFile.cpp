...
{
    // TODO: enable this in JUCE...
    jassert(progress == nullptr);
...
Result ZipFile::uncompressEntry (int index, const File& targetDirectory, OverwriteFiles overwriteFiles, FollowSymlinks followSymlinks, double* progress)
{
