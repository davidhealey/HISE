...
struct RestApiEndpoints
{
	...
	static void dspProbe(Array<RouteMetadata>& m)
	{
		...
		m.add(RouteMetadata(ApiRoute::DspProbe, "api/dsp/probe")
			...
			.withRequestExample(R"({"moduleId": "DspTestFX", "parent": "test_network", "injectIndex": 0, "probeIndex": -1, "signalType": "dirac", "gain": 1.0, "recursive": true, "filter": {"compact": true, "tree": true}})")
			.withResponseExample(R"({"success": true, "moduleId": "DspTestFX", "injectIndex": 0, "probeIndex": 1, "signalType": "dirac", "gain": 1.0, "seed": 1234, "recursive": true, "containers": {"test_network": {"factoryPath": "container.chain", "numChildren": 2, "children": [{"id": "Gain1", "factoryPath": "core.gain", "signal": [1.0, 1.0]}]}}, "tree": {"Gain1": "core.gain"}, "logs": [], "errors": []})"));
	}
